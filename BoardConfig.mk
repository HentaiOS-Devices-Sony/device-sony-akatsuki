...
ifneq (,$(filter %hentai_akatsuki_RoW,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := H8416
else ifneq (,$(filter %hentai_akatsuki_DSDS,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := H9436
else ifneq (,$(filter %hentai_akatsuki_RoW_Go,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := H8416
else ifneq (,$(filter %hentai_akatsuki_DSDS_Go,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := H9436
else
TARGET_BOOTLOADER_BOARD_NAME := H8416
